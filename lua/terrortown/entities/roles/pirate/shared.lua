...
function ROLE:Initialize()
	if CLIENT then
		...
		LANG.AddToLanguage("Italiano", PIRATE.name, "Pirata")
		LANG.AddToLanguage("Italiano", "info_popup_" .. PIRATE.name, [[Tu sei un Pirata! Cerca qualcuno per cui combattere - guadagna oro e punti.]])
		LANG.AddToLanguage("Italiano", "body_found_" .. PIRATE.abbr, "Era un Pirata...")
		LANG.AddToLanguage("Italiano", "search_role_" .. PIRATE.abbr, "Questa persona era un Pirata!")
		LANG.AddToLanguage("Italiano", "target_" .. PIRATE.name, "Pirata")
		LANG.AddToLanguage("Italiano", "ttt2_desc_" .. PIRATE.name, [[Il Pirata è un ruolo neutrale. Non gli interessa tanto chi è buono o cattivo… 
		...
		LANG.AddToLanguage("Italiano", "hilite_win_" .. TEAM_PIRATE, "I PIRATI HANNO VINTO") -- name of base role of a team -> maybe access with GetTeamRoles(ROLES.SERIALKILLER.team)[1].name
		LANG.AddToLanguage("Italiano", "win_" .. TEAM_PIRATE, "Il Pirata ha vinto! ARRRR") -- teamname
		LANG.AddToLanguage("Italiano", "ev_win_" .. TEAM_PIRATE, "I Pirati hanno reclamato il loro oro!")
